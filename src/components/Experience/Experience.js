            ...
            <div className="container-fluid">
                ...
                <div className="work-cards-container">
                    <Card className="work-card">
                        <div className="card-image" style={{backgroundImage: 'url(' + logoIBM + ')', backgroundSize: '60%'}}/>
                        <Card.Body>
                    ...
                    <Card className="work-card">
                        <div className="card-image" style={{backgroundImage: 'url(' + logoWingSwept + ')', backgroundSize: '60%'}}/>
                        <Card.Body>
                    ...
                    <Card className="work-card">
                        <div className="card-image" style={{backgroundImage: 'url(' + logoNCSU + ')', backgroundSize: '35%'}}/>
                        <Card.Body>
